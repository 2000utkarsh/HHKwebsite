...
############################# FORMS FOR SCORE ADMIN ############################

class get_score_analysis_type1_requirement_form(forms.Form):
...
class get_score_analysis_type2_requirement_form(forms.Form):
...
class get_score_analysis_type4_requirement_form(forms.Form):
